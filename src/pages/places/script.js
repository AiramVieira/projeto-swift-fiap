// Inicializar o mapa centrado no Brasil
        ...
        // Adicionar alguns marcadores iniciais
        ...
        // Funções para navegar para diferentes cidades
    
        
        // Adicionar marcador na posição central atual
        function addMarker() {
            const center = map.getCenter();
            const newMarker = L.marker([center.lat, center.lng])
                .addTo(map)
                .bindPopup(`<b>Novo Marcador</b><br>Lat: ${center.lat.toFixed(4)}<br>Lng: ${center.lng.toFixed(4)}`);
        ...
        map.on('click', function(e) {
            const marker = L.marker([e.latlng.lat, e.latlng.lng])
                .addTo(map)
                .bindPopup(`<b>Marcador Personalizado</b><br>Lat: ${e.latlng.lat.toFixed(4)}<br>Lng: ${e.latlng.lng.toFixed(4)}`);
